        ...
        <>
            ...
            <main className="w-11/12 mx-auto">
                <section className="pt-20 container mx-auto px-4 min-h-screen">
                    <h1 className="text-3xl font-bold text-center mt-12 mb-8">Update Movie</h1>
                    ...
                    <form onSubmit={handleSubmit} className="flex flex-col mx-auto items-center justify-center gap-y-5 w-2/4 mb-20">
                        ...
                        <input className="bg-red-600 text-white py-3 rounded hover:bg-red-700 w-full" type="submit" value="Update Movie" />
                    </form>
                </section>
            </main>
            <footer>
